-- Migration: Fix ambiguous achievement_id column reference (again)
-- Created: 2025-12-12
-- Description: Re-applies the fix for ambiguous achievement_id that was overwritten by migration 20251211140559
-- The previous fix (20251208000000) was overwritten when check_and_unlock_achievements was recreated
